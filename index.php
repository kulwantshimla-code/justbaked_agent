...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($input['email']) && isset($input['otp'])) {
        ...
        // ============================================================
        $smtp_host = 'winsome.grabweb.in'; 
        $smtp_port = 587; 
        $username  = 'sales@justbakedbytripti.com'; 
        $password  = '6Ek2k&66i';          
        // ============================================================

        $subject = "Your justbakedbytripti Verification Code";
            ...
            <div class="auth-content">
                <div class="auth-card">
                    <div class="auth-header">
                        ...
                        <h1>Welcome Back</h1>
                        <p>Sign in to continue to Justbaked</p>
                    </div>
             ...
             <div class="auth-content">
                <div class="auth-card">
                    <div class="auth-header">
                        ...
                        <p>Join the Justbaked community</p>
                    </div>
        ...
        <div id="appContainer" class="page">
            <header class="app-header">
                <div class="header-top">
                    <h1><i class="fas fa-leaf" style="margin-right:10px;"></i> Justbaked</h1>
